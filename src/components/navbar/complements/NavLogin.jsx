    ...
    return (
        <div className="dropdown text-end">
            <a href="/" className="d-inline link-light text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                <img src={ user.img ?? DefaultImg } alt="mdo" width="32" height="32" className="rounded-circle me-2" />
                <span className='username'>{ user.username }</span>
            </a>
            <ul className="dropdown-menu text-small" aria-labelledby="dropdownUser1" style={{right: '0', left: 'unset'}}>
                <li>
                    <Link className="dropdown-item" to="/profile">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-gear mx-1" viewBox="0 0 16 16">
                ...
                <li>
                    <Link className="dropdown-item" onClick={logout} to="/">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-box-arrow-in-left mx-1" viewBox="0 0 16 16">
