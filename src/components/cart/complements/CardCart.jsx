...
const CardCart = (props) => {
    ...
    return (
        <div className="card mb-1" key={"td"+index}>
            <div className="row g-0">
                <div className="col-sm-4 text-center">
                    <img src={ item.img } className="img-fluid rounded-start imgCard" alt="..." />
                </div>
                <div className="col-sm-8">
                    <div className="card-body">
                        ...
                        <div className="card-text">
                            <div className='row'>
                                <div className='col-md-5 p-0'> <PriceFormat price={item.price}/> </div>
                                <div className='col-md-2 text-center p-0'>  x { item.cant } = </div>
